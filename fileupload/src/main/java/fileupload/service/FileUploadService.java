...
public class FileUploadService {
	private static final String SAVE_PATH = "/Users/changnos/poscodx/workspace/spring-practices/fileupload/fileupload-files";
	...
	private String generateSaveFilename(String extName) {
		...
		return "" + calendar.get(Calendar.YEAR) + calendar.get(Calendar.MONTH) + calendar.get(Calendar.DATE)
				+ calendar.get(Calendar.HOUR) + calendar.get(Calendar.YEAR) + calendar.get(Calendar.MINUTE)
